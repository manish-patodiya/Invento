    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title"><i class="fa fa-list"></i>&nbsp; Vendor Purchase Order</h4>
                </div>
            </div>
        </div>
        <section class="content">
            <input type="hidden" name='trans_type_id' id='trans_type_id' value='4'>
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="VPO_detaila" class="table" width="100%">
                        <thead>
                            <div class="row mb-2" id='srch-filter'>
                                ...
                                <?php }?>
                                <div class="col-md-4">
                                    <?php if (check_method_access('vpo', 'add', true)) {?>
                                    <a href="<?php echo base_url("transaction/vpo/create_vpo") ?>"
                            ...
                            <tr>
                                ...
                                <th width='20%' scope="col">VPO No.</th>
...
$(function() {
    ...
    $(document).on('click', '.btn-statu-vpo', function() {
        let id = $(this).attr('vpo_attr');
        swal({
            title: "Are you sure?",
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/vpo/status"),
                    method: "post",
                    data: {
                        id: id,
                    },
    ...
    $("#VPO_detaila").DataTable({

        ajax: {
            url: base_url('/transaction/vpo/VPO_list'),
            dataSrc: 'details',
            data: function(data) {
    ...
    $('#daterange').on('apply.daterangepicker', function(ev, picker) {
        $("#VPO_detaila").DataTable().ajax.reload();
    });
    ...
    $('#cust_name').select2({
        ...
        ajax: {
            url: base_url('/transaction/vpo/getbranchaddress'),
            dataType: 'json',
            type: "GET",
    ...
    $(document).on('click', '.cancel', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/vpo/Cancel"),
                    method: "post",
                    data: {
                        id: id,
                    },
