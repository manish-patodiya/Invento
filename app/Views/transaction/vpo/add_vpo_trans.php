                        ...
                        <div class="m-3">
                            <form method="post" autocomplete="off" id="frm-create-transaction">
                                <div class="row">
                                    ...
                                    <!-- <div class="page-title col-md-4">
                                        <select name="Pinv_id" class='form-control' id="slc-est">
                                            ...
                                            <option value="<?//=$val->id?>" <?//=$val->id == $pinv_id ? "selected" :
                                                false?>>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Supplier<span
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12"><button type='submit' id='btn-save'
                                            class="mt-2 btn btn-success pull-right">
                                            Submit</button></div>
                                </div>
                            </form>
                        </div>
...
?>
<script src="<?=base_url('public/custom/js/transaction/vpo.js')?>"></script>
