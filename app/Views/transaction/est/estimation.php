...
$trans_id = isset($type_list['id']) ? $type_list['id'] : "";
?>
<style>
.btn-widht {
    font-weight: 300;
    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title"><i class="fa fa-list"></i>&nbsp; Estimation</h4>
                </div>
            </div>
        </div>

        <section class="content">
            <input type="hidden" name='trans_type_id' id='trans_type_id' value='1'>
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="EST_detaila" class="table" width="100%">
                        <thead>
                            <div class="row mb-2" id='srch-filter'>
                                ...
                                <?php } else {?>
                                <div class="col-md-4">
                                    <?php if (check_method_access('est', 'add', true)) {?>
                                    <a href="<?php echo base_url("transaction/est/create_estimation") ?>"
                            ...
                            <tr>
                                ...
                                <th width='20%' scope="col">Est No.</th>
...
<script src="<?=base_url('public/custom/js/transaction/est.js')?>"></script>