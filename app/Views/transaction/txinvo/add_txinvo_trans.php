                            ...
                            <form method="post" autocomplete="off" id="frm-create-transaction">
                                <div class="row">
                                    ...
                                    <div class="page-title col-md-4">
                                        <select name="tx_invo_id" class='form-control' id="slc-est">
                                            <option value="">Select CPO are DC
                                            </option>
                                            <?php foreach ($slc_est as $val) {?>
                                            <option value="<?=$val->id?>"
                                                <?=$val->id == $tx_invo_id ? "selected" : false?>>
...
?>
<script src="<?=base_url('public/custom/js/transaction/taxinvo.js')?>"></script>
