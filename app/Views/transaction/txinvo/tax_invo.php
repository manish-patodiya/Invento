    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title"><i class="fa fa-list"></i>&nbsp; Tax Invoices</h4>
                </div>
            </div>
        </div>
        <section class="content">
            <input type="hidden" name='trans_type_id' id='trans_type_id' value='8'>
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="TX_IN_detaila" class="table" width="100%">
                        <thead>
                            <div class="row mb-2" id='srch-filter'>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php } else {?>
                                    <div class="col-md-4">
                                        <?php if (check_method_access('taxinvo', 'add', true)) {?>
                                        <a href="<?php echo base_url("transaction/taxinvo/create_Txinvo") ?>"
                            ...
                            <tr>
                                ...
                                <th width='20%' scope="col">Tax Invo No.</th>
...
$(function() {
    "use strict";
    $(document).on('click', '.btn-statu-tax', function() {
        let id = $(this).attr('tax_attr');
        swal({
            title: "Are you sure?",
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/taxinvo/status"),
                    method: "post",
                    data: {
                        id: id,
                    },
    ...
    $("#TX_IN_detaila").DataTable({

        ajax: {
            url: base_url('/transaction/taxinvo/Taxinvo_List'),
            dataSrc: 'details',
            data: function(data) {
    ...
    $('#daterange').on('apply.daterangepicker', function(ev, picker) {
        $("#TX_IN_detaila").DataTable().ajax.reload();
    });
    ...
    $('#cust_name').select2({
        ...
        ajax: {
            url: base_url('/transaction/taxinvo/getbranchaddress'),
            dataType: 'json',
            type: "GET",
    ...
    $(document).on('click', '.cancel', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/taxinvo/Cancel"),
                    method: "post",
                    data: {
                        id: id,
                    },
