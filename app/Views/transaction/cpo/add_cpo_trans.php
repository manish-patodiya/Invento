    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center row">
                ...
                <div class="col-md-8 ">
                    <a href="#" onclick="history.back();" class="pull-right"></i>
                            ...
                            <form method="post" autocomplete="off" id="frm-create-transaction">
                                <div class="row">
                                    ...
                                    <div class="page-title col-md-4">
                                        <select name="est_id" class='form-control' id="slc-est">
                                            <option value="">Select EST</option>
                                            <?php foreach ($slc_est as $val) {?>
                                            <option value="<?=$val->id?>" <?=$val->id == $est_id ? "selected" : false?>>
...
?>
<script src="<?=base_url('public/custom/js/transaction/cpo.js')?>"></script>
