    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title"><i class="fa fa-list"></i>&nbsp; Rejection`s</h4>
                </div>
            </div>
        </div>
        <section class="content">
            <input type="hidden" name='trans_type_id' id='trans_type_id' value='12'>
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="rejection_details" class="table" width="100%">
                        <thead>
...
$(function() {
    ...
    $("#rejection_details").DataTable({

        ajax: {
            url: base_url('/transaction/rejection/rejection_list'),
            dataSrc: 'details',
            data: function(data) {
    ...
    $('#daterange').on('apply.daterangepicker', function(ev, picker) {
        $("#rejection_details").DataTable().ajax.reload();
    });
    ...
    $('#cust_name').select2({
        ...
        ajax: {
            url: base_url('/transaction/rejection/getbranchaddress'),
            dataType: 'json',
            type: "GET",
    ...
    $(document).on('click', '.cancel', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/rejection/Cancel"),
                    method: "post",
                    data: {
                        id: id,
                    },
...
function reload_list() {
    $("#voucher_detaila").DataTable().ajax.reload();
}
</script>