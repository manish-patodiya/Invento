    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title"><i class="fa fa-list"></i>&nbsp; Payment</h4>
                </div>
            </div>
        </div>
        <section class="content">
            <input type="hidden" name='trans_type_id' id='trans_type_id' value='11'>
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="PR_detaila" class="table" width="100%">
                        <thead>
                            <div class="row mb-2" id='srch-filter'>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php } else {?>
                                    <div class="col-md-6">
                                        <?php $branch_id = $session->user_details['branch_id']?>
                                        <a href="<?php echo base_url("transaction/payment/create_payment/$branch_id") ?>"
                            ...
                            <tr>
                                ...
                                <th width='20%' scope="col">PR No.</th>
...
$(function() {
    $('.select2').select2({
        ...
        $('#div-show').show();
        let id = $(this).val();
        let url = base_url("/transaction/payment/create_payment/") + id;
        $('#branch-id').attr('href', url);
        $("#PR_detaila").DataTable().ajax.reload();
    })
...
<script src="<?=base_url('public/custom/js/transaction/payment/tablepayment.js')?>"></script>