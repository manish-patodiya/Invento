                            ...
                            <form method="post" autocomplete="off" id="frm-create-transaction">
                                <div class="row">
                                    ...
                                    <div class="page-title col-md-4">
                                        <select name="Pinv_id" class='form-control' id="slc-est">
                                            <option value="">Select Cpo</option>
                                            <?php foreach ($slc_est as $val) {?>
                                            <option value="<?=$val->id?>"
                                                <?=$val->id == $pinv_id ? "selected" : false?>>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-10">
                                        <textarea name="details" id='details' autocapitalize
                                            placeholder='Payment, Mode of Despatch ECT., Vehicle No., LR No., LR Date, D.C. No. '
                                            class='form-control mt-2'></textarea>
                                    </div>
...
?>
<script src="<?=base_url('public/custom/js/transaction/pinv.js')?>"></script>
