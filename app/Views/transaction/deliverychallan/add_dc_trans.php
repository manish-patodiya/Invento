                            ...
                            <form method="post" autocomplete="off" id="frm-create-transaction">
                                <div class="row">
                                    ...
                                    <div class="page-title col-md-4">
                                        <select name="dc_invo_id" class='form-control' id="slc-est">
                                            <option value="">Select CPO</option>
                                            <?php foreach ($slc_est as $val) {?>
                                            <option value="<?=$val->id?>"
                                                <?=$val->id == $dc_invo_id ? "selected" : false?>>
                                                <?=$val->invoice_prefix_id?> </option>
                                            <?php }?>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Delivery Challan Type<span
                                                    class='mandatory'>*</span></label>
                                            <div class="controls">
                                                <select name="dc_type" class='form-control' id="dc_type"
                                                    data-validation-required-message="This field is required">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="controls">
                                                <select name="sec_branch" class='form-control' id="select-sec-branch"
                                                    ...
                                                    onchange='set_gst_no_and_address(this,true)'>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-10">
                                        <textarea name="details" id='details'
                                            placeholder='Sent for, Mode of Despatch ECT., Vehicle No., LR No., LR Date, D.C. No. '
                                            class='form-control mt-2'></textarea>
                                    </div>
                                    <div class="col-md-2"><button type='submit' class="mt-2 btn btn-success pull-right"
                                            id='btn-save'>
                                            Submit</button></div>
                                </div>
                            </form>
...
?>
<script src="<?=base_url('public/custom/js/transaction/dc.js')?>"></script>
