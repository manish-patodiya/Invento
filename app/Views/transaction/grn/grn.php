    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title"><i class="fa fa-list"></i>&nbsp; GRN</h4>
                </div>
            </div>
        </div>
        <section class="content">
            <input type="hidden" name='trans_type_id' id='trans_type_id' value='5'>
            <div class="card">
                <div class="card-body table-responsive">
                    <table id="GRN_detaila" class="table" width="100%">
                        <thead>
                            <div class="row mb-2" id='srch-filter'>
                                ...
                                <?php } else {?>
                                <div class="col-md-4">
                                    <?php if (check_method_access('grn', 'add', true)) {?>
                                    <a href="<?php echo base_url("transaction/grn/create_grn") ?>"
                            ...
                            <tr>
                                ...
                                <th width='20%' scope="col">GRN No.</th>
...
$(function() {
    ...
    $(document).on('click', '.btn-statu-grn', function() {
        let id = $(this).attr('grn_attr');
        swal({
            title: "Are you sure?",
            text: "This transaction is approved.",
            // type: "warning",
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/grn/status"),
                    method: "post",
                    data: {
                        id: id,
                    },
    ...
    $("#GRN_detaila").DataTable({

        ajax: {
            url: base_url('/transaction/grn/grn_list'),
            dataSrc: 'details',
            data: function(data) {
                data.frm_date = $('#daterange').data('daterangepicker').startDate
                    .format(
                        'YYYY-MM-DD');
    ...
    $('#daterange').on('apply.daterangepicker', function(ev, picker) {
        $("#GRN_detaila").DataTable().ajax.reload();
    });
    ...
    $('#cust_name').select2({
        ...
        ajax: {
            url: base_url('/transaction/grn/getbranchaddress'),
            dataType: 'json',
            type: "GET",
    ...
    $(document).on('click', '.cancel', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/grn/Cancel"),
                    method: "post",
                    data: {
                        id: id,
                    },
