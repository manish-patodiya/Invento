    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title"><i class="fa fa-plus"></i> Company General Setting </h4>
                </div>
        ...
        <section class="content">
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="m-3">
                        <h4 class="text-info mb-0"> Update Company Info</h4>
                        <hr class="my-15">
                        <form method="post" autocomplete="off" id="edit_general_settings" onsubmit="return false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" name="mobile_no" class="form-control"
                                                        ...
                                                        value="<?=$data['mobile']?>" placeholder="Enter your mobile no:"
                                                        data-validation-required-message="This field is required" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="ieccode" class="form-control" id="ieccode"
                                                        placeholder="Enter your ice-code"
                                                        value='<?=$data['iec_code']?>'>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="companyname" class="control-label"> CIN
                                                    (Corporate Identity
                                                    Number)</label>
                                                <div class="controls">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="companyname" class="control-label">State<span
                                                class='mandatory'>*</span></label>
                                        <div class="controls">
                                            <select name="state_id" class="form-control" id='g-state'
                                                data-validation-required-message="This field is required">
                                                <option value="">select state</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="citie_id" class="form-control" id='g-citie'
                                                data-validation-required-message="This field is required">
