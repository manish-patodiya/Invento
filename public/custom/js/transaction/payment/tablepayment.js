...
$(function () {
    $(document).on('click', '.btn-status-pr', function () {
        let id = $(this).attr('pr_attr');
        swal({
            title: "Are you sure?",
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/Payment/status"),
                    method: "post",
                    data: {
                        id: id,
                    },
    ...
    $("#PR_detaila").DataTable({

        ajax: {
            url: base_url('/transaction/Payment/PR_list'),
            dataSrc: 'details',
            data: function (data) {
    ...
    $('#cust_name').select2({
        ...
        ajax: {
            url: base_url('/transaction/Payment/getbranchaddress'),
            dataType: 'json',
            type: "GET",
    ...
    $(document).on('click', '.cancel', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: base_url("/Transaction/Payment/Cancel"),
                    method: "post",
                    data: {
                        id: id,
                    },
