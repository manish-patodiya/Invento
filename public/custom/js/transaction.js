...
function get_branch_list(val) {
    ...
    $.ajax({
        type: "post",
        url: base_url("/address/get_branch_list"),
        data: {
            cid: val,
        },
        dataType: "json",
...
function addProductRow() {
    ...
    $.ajax({
        type: "post",
        url: base_url("/product/Product/get_products_by_id"),
        data: {
...
function unit(unit_id, un_id) {
    ...
    console.log(id);
    $.ajax({
        url: base_url("/transaction/get_base_unit"),
        data: {
            id: id,
        },
        method: "post",
...
function searchProducts() {
    currentSearch = $.ajax({
        type: "GET",
        url: BASE_URL + "/product/Product/search_products",
        beforeSend: () => {
            if (currentSearch) {
                currentSearch.abort();
            }
...
//     $('#slct-category').select2();
//     $('#slct-product').select2({
...
//                                         <img src="${item.product_img||base_url('/public/images/product/product-1.png')}" width='100%'>
//                                     </div>
